...
图示：GitHub Models AI Playground 界面，包含模型选择和测试区域
...
图示：Playground 选择界面，展示多编程语言代码生成选项
...
图示：Create from template interface showing the green "Use this template" button
...
图示：Create codespace interface with options for launching cloud development environment
